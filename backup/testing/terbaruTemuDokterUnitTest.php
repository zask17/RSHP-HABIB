...
/**
 * UNIT TEST — Temu Dokter (Functionality & Validation)
 * Menguji business logic dan data validation untuk Appointment Temu Dokter
 * 
...
class TemuDokterUnitTest extends TestCase
{
     ...
     * Memastikan status appointment dapat di-update
     */
     ...
     * Memastikan nomor urut appointment dapat di-update
     */
     ...
     * Memastikan waktu appointment dapat di-update
     */
     ...
     * Memastikan multiple fields dapat di-update dalam satu operasi
     */
     ...
     * Memastikan appointment dapat dihapus
     */
     ...
     * Memastikan multiple appointments dapat dihapus bersamaan
     */
    ...
    {
        $temu = TemuDokter::factory()->create(['status' => 0]);
        $fresh = $temu->fresh();
     ...
     * Memastikan dapat bulk update status multiple appointments
     */
